  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row gy-4">
            <div className="col-lg-3">
              ...
              <p className="mb-0">
                Make your nights in Indore unforgettable with the company of a top-tier Indore call girl. These call girls offer more than just beauty; they bring charm, sophistication, and a personalized touch to every encounter.
              </p>
            </div>
            <div className="col-lg-8 offset-lg-1">
              <div className="row gy-4">
                ...
                <div className="col-md-4 col-6">
                  ...
                  <ul className="list-unstyled">
                    <li><a href="saket-nagar-call-girls.html">Saket Nagar Call Girls</a></li>
                    <li><a href="vijay-nagar-call-girls.html">Vijay Nagar Call Girls</a></li>
                    <li><a href="palasia-call-girls.html">Palasia Call Girls</a></li>
      ...
      <div className="nowcalling">
        <div className="lcol">
          <a href="tel:+919039103931">Call Now</a>
        </div>
        <div className="rcol">
          <a href="https://wa.me/+919039103931?text=Hi,%20I%20am%20looking%20escorts%20in%20Indore.%20[https://sakshisharma.in/]" target="_blank">WhatsApp</a>
        </div>
      </div>
    </>
  );
